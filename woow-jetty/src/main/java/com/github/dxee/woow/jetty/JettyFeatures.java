...
public class JettyFeatures {
     ...
     **/
    public static final String JETTY_CONNECTOR_HOST = "woow.jetty.connector.host";
    public static final String JETTY_CONNECTOR_HTTP_PORT = "woow.jetty.connector.http.port";

    /**
     * For jettry server
     **/
    public static final String JETTY_SERVER_MAXJETTYTHREADS = "woow.jetty.server.maxjettythreads";
    public static final String JETTY_SERVER_MINJETTYTHREADS = "woow.jetty.server.minjettythreads";

    public static final String JETTY_SERVLET_CONTEXT = "woow.jetty.servlet.context";

    /**
     * For HttpConfiguration
     */
    public static final String JETTY_HTTPCONFIGURATION_SENDXPOWEREDBY =
            "woow.jetty.httpconfiguration.sendxpoweredby";
    public static final String JETTY_HTTPCONFIGURATION_SENDSERVERVERSION =
            "woow.jetty.httpconfiguration.sendserverversion";
