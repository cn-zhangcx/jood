...
import com.github.dxee.jood.eventhandling.*;
import com.github.dxee.jood.consumer.ConsumerException;
import com.github.dxee.jood.consumer.KafConsumer;
import com.github.dxee.jood.consumer.MessageConsumer;
 ...
 * 2018-08-02 14:38
 */
public class KafkaProcessor implements EventProcessor, MessageConsumer<ConsumerRecord<String, byte[]>> {
    ...
    public KafkaProcessor(String topic, String consumerGroupId, Properties consumerProperties,
        ...
        kafConsumer = new KafConsumer<>(topic, consumerProperties, 1024, this);
    ...
    private void deliverToEventHandler(EventMessage<? extends Message> eventMessage,
                                       ...
                                       ErrorHandler errorHandler) {
        JoodContext context = eventMessage.getMetaData().newContextFromMetadata();
    ...
    private void deliveryStarted(EventMessage message, EventHandler handler, JoodContext context) {
