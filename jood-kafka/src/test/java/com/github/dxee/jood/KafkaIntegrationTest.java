...
public class KafkaIntegrationTest {
    ...
    public static class EventHandler1 {
        ...
        public void test(EventMessage<SayHelloToCmd> sayHelloToCmdEventMessage, JoodContext joodContext) {
            SayHelloToReply greeting = SayHelloToReply.newBuilder()
                    .setGreeting("Hello to " + sayHelloToCmdEventMessage.getPayload().getName())
                    .build();
            EventMessage reply = EventMessages.replyTo(sayHelloToCmdEventMessage, greeting, joodContext);
    ...
    public static class EventHandler2 {
        ...
        public void test(EventMessage<SayHelloToReply> sayHelloToReplyEventMessage, JoodContext joodContext) {
    ...
    public void simple_producer_consumer() throws InterruptedException {
        ...
        for (int i = 0; i < N; i++) {
            ...
            EventMessage request = EventMessages.requestFor(ping, pong, null, cmd, new JoodContext());
