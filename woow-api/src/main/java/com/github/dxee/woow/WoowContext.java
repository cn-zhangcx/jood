...
public class WoowContext {
    ...
    public WoowContext(Map<String, String> properties) {
        this(properties == null ? null : properties.remove("x-correlation-id"), properties);
    }

    public WoowContext(String correlationId, Map<String, String> properties) {
    ...
    public WoowContext(String correlationId) {
        this.correlationId = correlationId;
    }
