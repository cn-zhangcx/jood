...
public class JooContext {
    ...
    public JooContext(Map<String, String> properties) {
        this(properties == null ? null : properties.remove("x-correlation-id"), properties);
    }

    public JooContext(String correlationId, Map<String, String> properties) {
    ...
    public JooContext(String correlationId) {
        this.correlationId = correlationId;
    }
